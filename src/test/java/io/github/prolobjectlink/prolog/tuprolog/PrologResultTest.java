...
public class PrologResultTest extends PrologBaseTest {

	PrologResult result = provider.newResult(x).cast();
	...
	public void testHashCode() {
		assertEquals(provider.newResult(x).hashCode(), result.hashCode());
	}
	...
	public void testEqualsObject() {
		assertEquals(provider.newResult(x), result);
	}
	...
	public void testCast() {
		...
		assertTrue(result instanceof PrologResult);
	}
