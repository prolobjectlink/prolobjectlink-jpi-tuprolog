...
public class PrologParameterTest extends PrologBaseTest {

	PrologParameter parameter = provider.newParameter(x).cast();
	...
	public void testHashCode() {
		assertEquals(provider.newParameter(x).hashCode(), parameter.hashCode());
	}
	...
	public void testGetArguments() {
		assertArrayEquals(new PrologTerm[] {}, parameter.getArguments());
	}
	...
	public void testEqualsObject() {
		assertEquals(provider.newParameter(x), parameter);
	}
	...
	public void testCast() {
		...
		assertTrue(parameter instanceof PrologParameter);
	}
