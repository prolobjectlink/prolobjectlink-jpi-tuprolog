...
class TuPrologClauses extends AbstractList<PrologClause> implements PrologClauses {

	private final int arity;
	private final String functor;
	private final List<PrologClause> list;

	TuPrologClauses(String functor, int arity) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TuPrologClauses other = (TuPrologClauses) obj;
		if (list == null) {
			if (other.list != null)
				return false;
