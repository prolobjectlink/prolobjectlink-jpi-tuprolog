 ...
 * @since 1.1
 */
public final class TuPrologEntry extends AbstractCompounds implements PrologEntry {

	private final PrologTerm key;
	private PrologTerm value;

	TuPrologEntry(PrologProvider provider, PrologTerm key, PrologTerm value) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TuPrologEntry other = (TuPrologEntry) obj;
		if (key == null) {
			if (other.key != null)
				return false;
